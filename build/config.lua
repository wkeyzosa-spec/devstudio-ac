--[[
Dev Studio AC - Config
ACE Permissions (server.cfg):
  add_ace group.admin Anticheat.Bypass allow
  add_ace group.admin DevStudioAC.ACban allow
  add_ace group.admin DevStudioAC.admin allow
  add_ace group.admin AntiCheat.Moderation allow

Commands:
  /acban <id> <reason>      - Ban player manually
  /ac-unban <banID>         - Unban player by ban ID
  /aclicense                - Show license status
  /aclicense-reload         - Re-validate license
  /entitywipe <id>          - Remove player's spawned entities
  /latest                   - Show lowest playtime players
]]--
Config = {
    ...
    Webhook = {
        ...
        LeaveURL = "https://discordapp.com/api/webhooks/1523809835601236190/BEqkrvZX9IWvHjbG2Eu2zQfZCjz-r532tak_rLTDOwHJ36ERxrYDz7z4tysmClOT3jdK",
        Ban = {
            aimbot = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            noclip = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            spawn = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            health = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            spectate = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            command = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            esx = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            event = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            entity = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            chat = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            resource = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            key = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            manual = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            silent = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
            tp = "https://discordapp.com/api/webhooks/1523809983660032041/njy_FqhM5DE60BxJYsIleQwlvrBryuoQOe2QJZHzs-93KMQT9MAa_LsLr0vPLVjgwcie",
        },
        LogJoins = true,
        LogLeaves = true,
        LogBans = true,
    ...
    Components = {
         ...
         AntiESX = true,
         AntiWeapons = true,
         AntiRemoveOtherPlayersWeapons = true,
         AntiCancelAnimations = true,
         StopOtherPlayersGivingEachOtherWeapons = true,
         ModMenuChecks = true,
         StopUnauthorizedResources = true,
         AntiAimbot = true,
          AntiVehicleSpawn = true,
          AntiWeaponSpawn = true,
          AntiHealthArmor = true,
          AntiTP = true,
     },
    BanComponents = {
        AntiSpectate = true,
    ...
    Messages = {
        ...
        AimbotTriggered = "Our anticheat detected aimbot behavior. You have been banned.",
        VehicleSpawnTriggered = "Our anticheat detected unauthorized vehicle spawning. You have been banned.",
        WeaponSpawnTriggered = "Our anticheat detected unauthorized weapon spawning. You have been banned.",
        HealthArmorTriggered = "Our anticheat detected health/armor manipulation. You have been banned.",
        TPTriggered = "Our anticheat detected teleportation. You have been banned.",
    },
    BanAPI = {
        Enabled = true,
        Url = "https://devstudio-ac-1.onrender.com",
        Secret = "DsAcHmac!7e8f9a0b1c2d3e4f5a6b7c8d9e0f1a2b3c4d5e6f",
        SyncOnJoin = true,
        SyncOnBan = true,
    },
    AntiSpoof = {
        Enabled = true,
        LinkFingerprint = true,
    },
    KickForKeys = false, 
    BlacklistedKeys = { 
        {{121}, "Insert Key"},
